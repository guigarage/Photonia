package com.guigarage.photonia.cache;

import com.guigarage.photonia.data.Photo;
import com.guigarage.photonia.services.AsyncService;
...
public class PhotoniaThumbnailCache {
    ...
    public Future<Void> createThumbnail(Photo imageMetadata, AsyncService asyncService) {
    ...
    public void removeThumbnail(Photo imageMetadata) throws IOException {
    ...
    private void createThumbnailImpl(Photo imageMetadata) throws IOException {
        ...
        File thumbFolderFile = new File(thumbFolder, imageMetadata.getAlbum().getLocalFolder().getName());
    ...
    public boolean containsThumbnail(Photo imageMetadata) {
